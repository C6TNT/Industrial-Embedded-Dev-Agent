...
EulerAngles matrixToEulerAngles(RobotPosition tM_pos)
{
    ...
    if (angles.roll < -180.0) angles.roll += 360.0;
    if (angles.yaw > 180.0) angles.yaw -= 360.0;
    if (angles.yaw < -180.0) angles.yaw += 360.0;
...
RobotAngle InverseRobot(const RobotPosition& robotposition, RobotAngle& lastrobotangle)
{
    ...
    double s6, c6;
    c6 = robotposition.nx * (cos(robotangle.Angle5) * (
        cos(robotangle.Angle4) * cos(robotangle.Angle1) * cos(robotangle.Angle2 + robotangle.Angle3) + sin(robotangle.Angle4) * sin(robotangle.Angle1)
        ) - sin(robotangle.Angle5) * sin(robotangle.Angle2 + robotangle.Angle3) * cos(robotangle.Angle1)) +
        robotposition.ny * (
            cos(robotangle.Angle5) * (cos(robotangle.Angle4) * sin(robotangle.Angle1) * cos(robotangle.Angle2 + robotangle.Angle3)
            - sin(robotangle.Angle4) * cos(robotangle.Angle1))-sin(robotangle.Angle5)*sin(robotangle.Angle1)* sin(robotangle.Angle2 + robotangle.Angle3)
            ) +
        robotposition.nz * (
            -cos(robotangle.Angle5) * cos(robotangle.Angle4) * sin(robotangle.Angle2 + robotangle.Angle3) - sin(robotangle.Angle5) * cos(robotangle.Angle2 + robotangle.Angle3)
            );
    s6 = robotposition.nz * sin(robotangle.Angle4) * sin(robotangle.Angle2 + robotangle.Angle3) 
        - robotposition.nx * (
            sin(robotangle.Angle4) * cos(robotangle.Angle1) * cos(robotangle.Angle2 + robotangle.Angle3) 
            - cos(robotangle.Angle4) * sin(robotangle.Angle1)
            ) - robotposition.ny * (
                sin(robotangle.Angle4) * sin(robotangle.Angle1) * cos(robotangle.Angle2 + robotangle.Angle3) + cos(robotangle.Angle4) * cos(robotangle.Angle1)
                );
