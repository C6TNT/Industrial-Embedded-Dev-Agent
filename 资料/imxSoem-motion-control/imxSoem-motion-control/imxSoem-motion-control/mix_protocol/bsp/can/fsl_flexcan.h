...
typedef struct _flexcan_frame
{
    ...
    union
    {
        ...
        struct
        {
            uint8_t dataByte0; /*!< CAN Frame payload byte3. */
            uint8_t dataByte1; /*!< CAN Frame payload byte2. */
            uint8_t dataByte2; /*!< CAN Frame payload byte1. */
            uint8_t dataByte3; /*!< CAN Frame payload byte0. */
            uint8_t dataByte4; /*!< CAN Frame payload byte7. */
            uint8_t dataByte5; /*!< CAN Frame payload byte6. */
            uint8_t dataByte6; /*!< CAN Frame payload byte5. */
            uint8_t dataByte7; /*!< CAN Frame payload byte4. */
        };
    };
} flexcan_frame_t;
