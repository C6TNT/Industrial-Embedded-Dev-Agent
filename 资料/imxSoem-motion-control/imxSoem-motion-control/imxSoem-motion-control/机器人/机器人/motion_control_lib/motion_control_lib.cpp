...
int32_t Weld_Direct_GetDriveTargetVel(SYS_HANDLE *ihandle, int32_t iaxis, int32_t *piValue)
{
    int32_t ret;
    double data[1];
    ret = parameter_get(ihandle,(iaxis + 0x4000),0x14,1,data,Weld_Direct_GetDriveTargetVelFailed);
    *piValue = data[0];
    return ret;
}
...
int32_t Weld_Direct_GetDriveMode(SYS_HANDLE *ihandle, int32_t iaxis, int32_t *piValue)
{
    int32_t ret;
    double data[1];
    ret = parameter_get(ihandle,(iaxis + 0x4000),0x16,1,data,Weld_Direct_GetDriveModeFailed);
    *piValue = data[0];
    return ret;
}
...
int32_t Weld_Direct_GetDriveDisplay(SYS_HANDLE *ihandle, int32_t iaxis, int32_t *piValue)
{
    int32_t ret;
    double data[1];
    ret = parameter_get(ihandle,(iaxis + 0x4000),0x18,1,data,Weld_Direct_GetDriveDisplayFailed);
    *piValue = data[0];
    return ret;
}
...
int32_t Weld_Direct_GetDriveControlWord(SYS_HANDLE *ihandle, int32_t iaxis, int32_t *piValue)
{
    int32_t ret;
    double data[1];
    ret = parameter_get(ihandle,(iaxis + 0x4000),0x1A,1,data,Weld_Direct_GetDriveControlWordFailed);
    *piValue = data[0];
    return ret;
}
...
int32_t Weld_Direct_GetDriveStatusWord(SYS_HANDLE *ihandle, int32_t iaxis, int32_t *piValue)
{
    int32_t ret;
    double data[1];
    ret = parameter_get(ihandle,(iaxis + 0x4000),0x1C,1,data,Weld_Direct_GetDriveStatusWordFailed);
    *piValue = data[0];
    return ret;
}
